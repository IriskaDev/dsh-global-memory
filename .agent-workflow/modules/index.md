...
| memory-tools | 记忆工具注册模块 | MODULE | 注册 4 个 `memory_*` 工具 + 2 个 slash 命令 + 会话首 step 自动注入条目级索引                             | 🟢 已完成 | 🟢 有效 | 2026-08-17 | memory,tools,commands,systemPrompt,index | [memory-tools.md](./memory-tools.md) |
